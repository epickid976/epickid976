...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func unlockSecretMessage() {
        ...
        let data = KeychainWrapper.standard.data(forKey: "People")
        parse(json: data!)
    ...
    @objc func saveSecretMessage() {
        let encoder = JSONEncoder()
            ...
            KeychainWrapper.standard.set(encoded, forKey: "People")

        self.navigationItem.rightBarButtonItem?.isEnabled = false
        if let vc = storyboard?.instantiateViewController(withIdentifier: "Authenticate") as? AuthenticateController{
    ...
    func parse(json: Data) {
        ...
        if let jsonPetitions = try? decoder.decode([Person].self, from: json) {
            people = jsonPetitions
        }
    }
}
