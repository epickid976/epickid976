...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var currentPlayer = 1
    var wind = ["East" : CGVector(dx: 5, dy: -9.8),           "West" : CGVector(dx: -5, dy: -9.8)]
    ...
    override func didMove(to view: SKView) {        
        ...
        DispatchQueue.main.async {
            ...
            switch random {
            case 1:
                self.physicsWorld.gravity = self.wind["East"]!
                self.viewController?.windDirection = "East"
                
            case 2:
                self.physicsWorld.gravity = self.wind["West"]!
                self.viewController?.windDirection = "West"
