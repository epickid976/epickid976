...
//  Project 23
//
//  Created by Jose Blanco on 7/3/22.
//
...
class GameScene: SKScene {
    ...
    let randomEnemyPosition = CGPoint(x: Int.random(in: 64...960), y: -128)
    let randomEnemyAngularVelocity = CGFloat.random(in: -3...3)
    let randomEnemyYVelocity = Int.random(in: 24...32)
    ...
    func createEnemy(forceBomb: ForceBomb = .random) {
        ...
        let randomSpecialEnemy = Int.random(in: 1...10)
        ...
        } else if randomSpecialEnemy == 2 || randomSpecialEnemy == 8{
        ...
        if randomEnemyPosition.x < 256 {
            randomXVelocity = 15
        } else if randomEnemyPosition.x < 512 {
            randomXVelocity = 5
        } else if randomEnemyPosition.x < 768 {
            randomXVelocity = -5
        } else {
            randomXVelocity = -15
        }
        ...
        enemy.physicsBody?.velocity = CGVector(dx: randomXVelocity * 40, dy: randomEnemyYVelocity * 40)
        
        
        enemy.physicsBody?.angularVelocity = randomEnemyAngularVelocity
        enemy.physicsBody?.collisionBitMask = 0
        
        if enemy.name == "enemySpecial" {
            enemy.physicsBody?.velocity = CGVector(dx: randomXVelocity * 45, dy: randomEnemyYVelocity * 45)
